      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {content.sections.clients.items.map((item, index) => (
          <div
            ...
            className="group relative rounded-2xl border border-black/10 bg-white/70 backdrop-blur p-8 overflow-hidden cursor-pointer depth-shadow"
            style={{ transformStyle: "preserve-3d" }}
          >
            <div
              aria-hidden="true"
              className="absolute inset-0 bg-gradient-to-br from-[var(--color-primary)]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"
            />
            
            <div className="relative z-10">
              <div className="inline-flex items-center justify-center w-14 h-14 rounded-xl bg-[var(--color-primary)]/10 mb-4 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
              ...
              <p className="font-[var(--font-body)] text-[var(--color-slate)] leading-relaxed">
                {item.description}
              </p>
            </div>

            <div
              className="absolute -bottom-10 -right-10 w-32 h-32 rounded-full bg-[var(--color-primary)]/10 blur-2xl opacity-0 group-hover:opacity-100 transition-all duration-500"
            ...
            <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" 
                 style={{ 
                   boxShadow: `inset 0 0 20px rgba(196, 30, 58, 0.1), 0 0 20px rgba(196, 30, 58, 0.05)` 
                 }} 
            />
          </div>
        ))}
